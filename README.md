...
8. Now just load your cloud url in browser (for me it was http://localhost/) and this will be fully functional website running in production cloud environment
